...
namespace Tests\Feature\Auth\Registration\Category;
...
class CreateControllerTest extends TestCase
{
    ...
    {
        $this->post(route('registration.opening-hours.post'))
    ...
    public function table_is_populated_when_called_with_valid_data(): void
    {
        ...
        $response = $this->post(route('registration.categories.post'), $categories);

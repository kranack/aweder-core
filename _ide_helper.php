 ...
 * Generated for Laravel 7.19.1 on 2020-07-11 17:10:16.
 *
...
namespace Olssonm\Zxcvbn\Facades { 
    ...
    class Zxcvbn {
         ...
         * @static 
         */ 
        public static function addMatcher($className)
        {
                        /** @var \ZxcvbnPhp\Zxcvbn $instance */
                        return $instance->addMatcher($className);
        }
         ...
         * @static 
         */ 
        public static function passwordStrength($password, $userInputs = [])
        {
                        /** @var \ZxcvbnPhp\Zxcvbn $instance */
                        return $instance->passwordStrength($password, $userInputs);
        }
...
namespace  { 
    ...
    class Zxcvbn extends \Olssonm\Zxcvbn\Facades\Zxcvbn {}

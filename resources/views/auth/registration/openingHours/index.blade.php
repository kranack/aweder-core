        ...
        <div class="row">
            <div class="content">
                <header class="auth__header col-span-6 col-start-4 m-col-span-10 m-col-start-2 sm-col-span-6 sm-col-start-1">
                    <h1 class="header-one color-carnation margin-bottom-40">Opening Hours</h1>
                    <p>Add the days and times which you’re available to take orders on. If you have different table order times to your take away service, you can add those as well.</p>
                </header>
                <form class="col-span-6 col-start-4 m-col-span-10 m-col-start-2 sm-col-span-6 sm-col-start-1"
                      ...
                      method="POST">
                    @csrf
                    <div class="panel flex flex-col width-full background-off-white">
                        <opening-hours
...
{{--                                    <input id="monday-status" type="checkbox" name="is_open" checked="checked" class="hidden" />--}}
{{--                                    <label for="monday-status" class="opening-time__checkbox">--}}
{{--                                        <span class="icon">@svg('tick', 'stroke-cloud-burst')</span>--}}
{{--                                    </label>--}}
{{--                                </div>--}}
{{--                                <p>Monday</p>--}}
{{--                            </div>--}}
...
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <span class="opening-time__add">--}}
{{--                                <span class="icon">@svg('add', 'fill-carnation')</span>--}}
{{--                                Add extra hours--}}
{{--                            </span>--}}
{{--                        </div>--}}

@extends('global.app')
@section('content')
    <section class="hero background-ecru-white-3 margin-bottom-80">
        <div class="row">
            <div class="content align-items-center">
                ...
                <div class="hero__image col-span-3 col-start-9 row-span-2 row-start-1 sm-col-span-4 sm-col-start-2 sm-row-start-3 sm-row-span-1">
    ...
    <section class="feature">
        <div class="row">
            <div class="content align-items-center">
                <div class="feature__content col-span-5 col-start-7 inline-flex flex-col">
                ...
                <div class="feature__image col-span-4 col-start-2">
    ...
    <section class="feature">
        <div class="row">
            <div class="content">
                <div class="feature__content col-span-5 col-start-2 inline-flex flex-col">
                    <header class="feature__header">
                ...
                <div class="feature__image col-span-4 col-start-7">
